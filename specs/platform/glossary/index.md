...
| Term | Definition |
|------|-------------|
| **Nubus** | Identity and access management platform (Univention GmbH) comprising OpenLDAP, Keycloak, Portal, UMC, UMS REST API. See spec: [services/nubus](../services/nubus/) |
...
| **Shibboleth IdP** | External federation gateway (DFN-AAI/eduGAIN) — NOT Keycloak. See spec: [auth/federation](../auth/federation/) |
...
- [API Contracts](../integrations/api-contracts/) — HTTP endpoint contracts, token formats
- [Deployment](./deployment/) — Helmfile, deployment waves
- [Networking](./networking/) — Ingress, DNS, proxy
- [Monitoring](./monitoring/) — Prometheus, Grafana, alerting
- [Disaster Recovery](./disaster-recovery/) — Backup restore, failover
